...
#' @description
#' Density, distribution function, quantile function and random generation for the Weighted Geometric distributions parameters.
#' @return \code{dwgd} gives the density, \code{pwgd} gives the distribution function, \code{qwgd} gives the quantile function and \code{rwgd} generates random deviates.
#' @details
#' The Weighted Geometric distribution with parameters \eqn{\alpha} and \eqn{\lambda}, has density given by
