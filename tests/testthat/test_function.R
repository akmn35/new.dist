...
test_that("functions returns a  vector with the expected size", {
  ...
  expect_vector(pwgd(1, alpha=.2, lambda=3, lower.tail = F), ptype = double(), size = 1)
  expect_vector(pwgd(1, alpha=.2, lambda=3, log.p = T), ptype = double(), size = 1)
  expect_vector(qwgd(.1, alpha=.2, lambda=3), ptype = double(), size = 1)
  expect_vector(qwgd(.1, alpha=.2, lambda=3, lower.tail = F), ptype = double(), size = 1)
